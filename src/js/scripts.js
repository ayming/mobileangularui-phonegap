...
app.config(function($routeProvider, $locationProvider) {
  $routeProvider.when('/',          {templateUrl: 'assets/template/home.html'});
  $routeProvider.when('/scroll',    {templateUrl: 'assets/template/scroll.html'}); 
  $routeProvider.when('/toggle',    {templateUrl: 'assets/template/toggle.html'}); 
  $routeProvider.when('/tabs',      {templateUrl: 'assets/template/tabs.html'}); 
  $routeProvider.when('/accordion', {templateUrl: 'assets/template/accordion.html'}); 
  $routeProvider.when('/overlay',   {templateUrl: 'assets/template/overlay.html'}); 
  $routeProvider.when('/forms',     {templateUrl: 'assets/template/forms.html'});
  $routeProvider.when('/carousel',  {templateUrl: 'assets/template/carousel.html'});
});
